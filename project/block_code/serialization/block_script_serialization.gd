...
const SCENE_PER_TYPE = {
	...
	Types.BlockType.STATEMENT: preload("res://block_code/ui/blocks/statement_block/statement_block.tscn"),
	Types.BlockType.VALUE: preload("res://block_code/ui/blocks/parameter_block/parameter_block.tscn"),
	Types.BlockType.CONTROL: preload("res://block_code/ui/blocks/control_block/control_block.tscn"),
}

@export var script_inherits: String
@export var script_extends: ScriptExtends
