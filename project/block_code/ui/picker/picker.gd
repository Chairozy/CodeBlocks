...
const BlockCategoryButtonScene = preload("res://block_code/ui/picker/categories/block_category_button.tscn")
const BlockCategoryButton = preload("res://block_code/ui/picker/categories/block_category_button.gd")
const BlockCategoryDisplay = preload("res://block_code/ui/picker/categories/block_category_display.gd")
const BlockCategoryDisplayScene = preload("res://block_code/ui/picker/categories/block_category_display.tscn")
const VariableCategoryDisplayScene = preload("res://block_code/ui/picker/categories/variable_category/variable_category_display.tscn")
...
func _category_selected(category_name: String):
	var block_category_display := _category_displays.get(category_name) as BlockCategoryDisplay
